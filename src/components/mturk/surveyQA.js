...
const SurveyScreenQA = ({ setState, sInfo, returnSurvey }) => {
  const [answers, setAnswers] = useState({
    q1: '', q2: '', q3: '', q4: '', q5: '', q6: '', q7: '', q8: 'N/A', q9: '',
  ...
  return (
    <Container component="main" maxWidth="md">
      ...
      <QuestionCard2
        question={<span>Q7: I found the chatbot interrupting my learning process.</span>}
        choices={choices}
      ...
      <QuestionCard2
        question={<span>Q8: Interacting with the chatbot improved my understanding of the lesson.</span>}
        choices={choices}
      ...
      <QuestionCard2
        question={<span>Q9: Interacting with the chatbot helped me remember the lesson.</span>}
        choices={choices}
      ...
      <QuestionCard2
        question={<span>Q10: I got the support I needed from the chatbot to learn the lesson.</span>}
        choices={choices}
      ...
      <QuestionCard2
        question={<span>Q11: The conversations with the chatbot were coherent.</span>}
        choices={choices}
      ...
      <QuestionCard2
        question={<span>Q12: I enjoyed interacting with the chatbot.</span>}
        choices={choices}
      ...
      <QuestionCard2
        question={<span>Q13: I would like to interact with the chatbot again in the future when learning new lessons.</span>}
        choices={choices}
