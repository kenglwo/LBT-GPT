...
import useChat from './UseChatQABot';
...
const LBTApplicationQABot = ({ setState, sInfo, returnSurvey, QATopics }) => {
  ...
  const { chat, message, setMessage, sendMessage, chatLog } = useChat(setUsedBot, setCompleted, QATopics, sInfo);
      ...
      <div className="main-container">
        <div className="chat-container">
          <div className="parent-vertical">
            <Typography>Learn By Doing:</Typography>
...
export default LBTApplicationQABot;
