...
export default function Test1(props) {
  ...
  useEffect(() => {
    ...
    const answerArray = [answer0_1, answer0_2, answer0_3, answer1, answer2_1, answer2_2, answer2_3, answer3];

    setStudentAnswerArray(answerArray);
  }, [studentAnswer0_1, studentAnswer0_2, studentAnswer0_3, studentAnswer1, studentAnswer2_1, studentAnswer2_2, studentAnswer2_3, studentAnswer3]); // 添加依赖项数组
    ...
    switch (currentPage) {
        ...
        return (
          <>
            ...
            <strong className='question_text'>
              ...
              <span style={{ color: 'green', fontWeight: 'bold' }}> data mining &amp;</span> 
              <span style={{ color: 'green', fontWeight: 'bold' }}>data visualization</span>,
              <span style={{ color: 'green', fontWeight: 'bold' }}>color encoding</span>,
              <span style={{ color: 'green', fontWeight: 'bold' }}>color scheme &amp;</span>
              <span style={{ color: 'green', fontWeight: 'bold' }}>color map</span>.
            </strong>
            <br />
            <strong>
              Please use 10 minutes to explore and learn these concepts with GPT and then finish this test.
            </strong>
      ...
      case 2:
        return (
          <>
            <Box sx={{ m: 3 }}>
              <strong className='question_text'>
                0.1 What is the relationship between data mining and data visualization?
              </strong>
              <TextField
            ...
            <Box sx={{ m: 3 }}>
              <strong className='question_text'>
                0.2 What is encoding in data visualization? Could you give some examples?
              </strong>
              <TextField
                sx={{ width: '90%', ml: 2, mt: 2 }}
                id='answer_zone_0_2'
      ...
      case 3:
        return (
          <>
            ...
            <img src={test_0101_figure} alt="User Uploaded" style={{ maxWidth: '75%', height: 'auto' }} />
      ...
      case 4:
        return (
          <>
            <p>Please analyze the color scheme used in the PG defense demo: </p>
            <img src={test_0102_figure} alt="User Uploaded" style={{ maxWidth: '50%', height: 'auto' }} />
            <Box sx={{ m: 3 }}>
              <strong className='question_text'>
                2.1 In the supervisor view, can you deduce or interpret what does the color encode?
              </strong>
              <TextField
                sx={{ width: '90%', ml: 2, mt: 2 }}
                id='answer_zone_2_1'
