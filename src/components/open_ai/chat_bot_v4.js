...
Step 2: ${delimiter} Determine if the teacher's response contains factually incorrect information; if yes, gently point it out
...
Step 4: ${delimiter} Determine if the teacher addresses the professor directly for help; if yes, provide relevant information
...
Make sure to always write a comment for the teacher.`;
